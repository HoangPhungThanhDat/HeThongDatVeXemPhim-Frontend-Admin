...
import {
  ...
  export function ConfirmDeleteModal({ isOpen, onClose, onConfirm, article }) {
          ...
          <ModalBody px="20px" py="14px">
            ...
            >
              ...
              <Text fontSize="11.5px" color="#6b7280" mt="3px">
                {article.Status || article.status || "Bản nháp"} · {article.views || 0} lượt xem
              </Text>
            </Box>
            <Text fontSize="13px" color={descColor} lineHeight="1.7">
              ...
              Toàn bộ dữ liệu của bài viết sẽ bị xóa vĩnh viễn khỏi hệ thống.
            </Text>
          </ModalBody>
