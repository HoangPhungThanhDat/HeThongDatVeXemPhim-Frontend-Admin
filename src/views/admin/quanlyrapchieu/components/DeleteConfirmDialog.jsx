...
const DeleteConfirmDialog = ({ isOpen, onClose, onConfirm, cinemaName }) => {
      ...
      <AlertDialogOverlay backdropFilter="blur(4px)">
        <AlertDialogContent bg={bg} borderRadius="20px" border={`1px solid ${isDark ? "#334155" : "#e2e8f0"}`}>
          ...
          <AlertDialogBody color={isDark ? "#94a3b8" : "#64748b"}>
            Bạn có chắc chắn muốn xóa rạp <strong>{cinemaName}</strong>?
            <Text fontSize="12px" mt="6px" color="#dc2626">
              Lưu ý: Hành động này sẽ xóa vĩnh viễn rạp và tất cả dữ liệu liên quan. Không thể khôi phục.
            </Text>
          </AlertDialogBody>
          <AlertDialogFooter>
