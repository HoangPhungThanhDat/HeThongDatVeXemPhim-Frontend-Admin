...
import {
  ...
  export function ConfirmDeleteModal({ isOpen, onClose, onConfirm, artist }) {
    ...
    const movieCount = artist.movies ? artist.movies.length : 0;
          ...
          <ModalBody px="20px" py="14px">
            ...
            >
              ...
              <Text fontSize="11.5px" color="#6b7280" mt="3px">
                {artist.Role || artist.role || "Diễn viên"} · {movieCount} phim tham gia
              </Text>
            </Box>
            <Text fontSize="13px" color={descColor} lineHeight="1.7">
              Nghệ sĩ sẽ bị xóa vĩnh viễn khỏi hệ thống.
              {movieCount > 0 && (
                <Text as="span" fontWeight="700" color="#ef4444">
                  ⚠️ Đang liên kết với <strong>{movieCount} phim</strong>.
                </Text>
              )}
            </Text>
          </ModalBody>
