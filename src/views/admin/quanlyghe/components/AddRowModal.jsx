...
export default function AddRowModal({ isOpen, onClose, onAdd, roomName, currentRows }) {
          ...
          <VStack spacing="16px" align="stretch">
            <Box p="12px 14px" borderRadius="10px" bg={isDark ? "#2d3748" : "#f8fafc"}>
              ...
              <Text fontSize="12px" color={colors.subColor} mt="4px">
                Hiện tại: <strong color={colors.textColor}>{currentRows} hàng</strong>
              </Text>
            </Box>
            ...
            <FormControl>
              ...
              <NumberInput
                ...
                max={10}
                value={rowCount}
                onChange={(_, val) => setRowCount(val || 1)}
              >
                <NumberInputField 
                  bg={colors.bgInput}
            ...
            <FormControl>
              ...
              >
                <option value="end">Cuối danh sách (sau hàng cuối)</option>
                <option value="start">Đầu danh sách (trước hàng đầu)</option>
              </Select>
            </FormControl>
          </VStack>
