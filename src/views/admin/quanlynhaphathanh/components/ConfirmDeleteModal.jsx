...
import {
  ...
  export function ConfirmDeleteModal({ isOpen, onClose, onConfirm, distributor }) {
        ...
        >
          <ModalHeader p="20px 20px 0">
            <Flex align="center" gap="10px">
              <Box 
                w="58px" h="58px" borderRadius="full" bg={bodyBg}
          ...
          <ModalBody px="20px" py="14px">
            ...
            >
              ...
              <Text fontSize="11.5px" color="#6b7280" mt="3px">
                {distributor.Status || distributor.status || "Active"} · {distributor.moviesCount || 0} phim
              </Text>
            </Box>
            <Text fontSize="13px" color={descColor} lineHeight="1.7">
              Nhà phát hành sẽ bị xóa vĩnh viễn khỏi hệ thống.
              {distributor.moviesCount > 0 && (
                <Text as="span" fontWeight="700" color="#ef4444">
                  ⚠️ Đang liên kết với <strong>{distributor.moviesCount} phim</strong>.
                </Text>
              )}
            </Text>
          </ModalBody>
          <ModalFooter px="20px" pb="20px" gap="8px">
            <Button 
              flex="1" h="44px" borderRadius="10px" variant="ghost"
              color={descColor}
