        ...
        <div className="main-container">
          <div className="pd-ltr-20">
            <div className="loading-container">
              ...
              <h5 className="loading-title">Đang tải dữ liệu thể loại phim...</h5>
          ...
          <div className="pd-ltr-20">
            <div className="no-data-container">
              <div className="no-data-content">
                ...
                <p className="no-data-text">Không có dữ liệu thể loại phim.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="role-show-container">
            ...
            <div className="role-show-content">
              ...
              <div className="header-section">
                <div>
                  <button onClick={() => navigate("/genre")} className="back-button">
                    <ArrowLeft size={16} />
                    Quay lại danh sách
                  </button>
                  <h1 className="page-title">Chi Tiết Thể Loại Phim</h1>
                  <p className="page-subtitle">
                    Xem thông tin chi tiết và quản lý thể loại phim
                  </p>
                </div>

                <div className="header-actions">
                  <button
                    onClick={() => navigate(`/genre/edit/${GenreId}`)}
              ...
              <div className="main-grid">
                ...
                <div className="role-summary-card">
                  ...
                  {/* Genre Name */}
                  <h2 className="role-name">{genre.Name}</h2>
                  ...
                  <div className="role-id-box">
                    <div className="role-id-label">ID Thể Loại</div>
                    <div className="role-id-value">{genre.GenreId}</div>
                  </div>
                </div>
                  ...
                  <div className="info-card">
                    <div className="info-header">
                      ...
                      <div>
                        ...
                        <p className="info-subtitle">Chi tiết về người tạo thể loại</p>
                      </div>
                    </div>
                    ...
                    <div className="info-items">
                      <div className="info-item">
                        ...
                        <div className="info-item-content">
                          ...
                          <div className="info-item-value">{genre.CreatedBy || "N/A"}</div>
                        </div>
                      </div>
                      ...
                      <div className="info-item">
                        ...
                        <div className="info-item-content">
                          ...
                          <div className="info-item-value">{genre.CreatedAt || "N/A"}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="info-card">
                    <div className="info-header">
                      ...
                      <div>
                        ...
                        <p className="info-subtitle">Lịch sử thay đổi thể loại</p>
                      </div>
                    </div>
                    ...
                    <div className="info-items">
                      <div className="info-item">
                        ...
                        <div className="info-item-content">
                          ...
                          <div className="info-item-value">{genre.UpdatedBy || "N/A"}</div>
                        </div>
                      </div>
                      ...
                      <div className="info-item">
                        ...
                        <div className="info-item-content">
                          ...
                          <div className="info-item-value">{genre.UpdatedAt || "N/A"}</div>
                        </div>
                      </div>
                    </div>
                  </div>
