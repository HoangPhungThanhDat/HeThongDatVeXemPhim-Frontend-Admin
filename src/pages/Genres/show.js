        ...
        <div className="main-container">
          <div className="pd-ltr-20">
            <div className="d-flex flex-column align-items-center justify-content-center p-5">
              ...
              ></div>
              <h5 style={{ color: "#f7931e" }}>Đang tải dữ liệu thể loại phim...</h5>
          ...
          <div className="pd-ltr-20">
            ...
            >
              ...
              >
                ...
                />
                <p style={{ fontSize: "18px" }}>Không có dữ liệu thể loại phim.</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          Chi tiết về người tạo thể loại
                        </p>
                      </div>
                    </div>
