...
export default function MovieGenresEdit() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (!MovieGenreId) {
          setError("Thiếu MovieGenreId trong URL");
          return;
        }
        ...
        const mg = mgRes.data.data || mgRes.data;
        setMovieGenres(mg);
        setMovies(movieRes.data.data || []);
        setGenres(genreRes.data.data || []);
      } catch (err) {
        console.error("❌ Lỗi load MovieGenres:", err);
  ...
  const handleChange = (e) => {
    ...
    setMovieGenres((prev) => ({ ...prev, [name]: value }));
  };
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      ...
      Status: movieGenres.Status,
    };

    MovieGenresApi.update(MovieGenreId, payload)
      .then(() => {
        Swal.fire({
          toast: true,
          position: "top-end",
          icon: "success",
          title: "🎉 Cập nhật liên kết phim - thể loại thành công!",
          ...
          <div className="pd-ltr-20">
            <div className="container role-show-container">
              <div className="text-center p-5 text-muted">
                ...
                <p>Không có dữ liệu liên kết phim - thể loại.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="form-section">
              <div className="section-header">
                ...
                <div className="header-text">
                  <h1 className="section-title">Cập nhật Liên Kết Phim - Thể Loại</h1>
                  <p className="section-subtitle">
                    Chỉnh sửa thông tin liên kết
                  </p>
                </div>
              </div>
                    ...
                    <div className="status-selector">
                      <div
                        className={`status-option ${
                          movieGenres.Status === "Active" ? "active" : ""
                        }`}
                        onClick={() =>
                          setMovieGenres((prev) => ({ ...prev, Status: "Active" }))
                        }
                      >
                        <div className="status-radio">
                          {movieGenres.Status === "Active" && (
                      ...
                      <div
                        className={`status-option ${
                          movieGenres.Status === "Inactive" ? "active" : ""
                        }`}
                        onClick={() =>
                          setMovieGenres((prev) => ({
                            ...prev,
            ...
            <div className="info-section">
              ...
              <div className="info-card">
                ...
                <div className="info-list">
                  <div className="info-item">
                    <span className="info-key">ID Liên kết:</span>
                    <span className="info-value">{movieGenres.MovieGenreId}</span>
                  </div>
                  <div className="info-item">
              ...
              <div className="info-card tips-card">
                ...
                <div className="tip-item">
                  ...
                  <p>Chọn phim và thể loại từ danh sách có sẵn</p>
                </div>
                <div className="tip-item">
                  <i className="fas fa-check-circle tip-icon"></i>
                  <p>Liên kết giúp phân loại phim theo thể loại</p>
                </div>
                <div className="tip-item">
                  <i className="fas fa-check-circle tip-icon"></i>
                  <p>Trạng thái "Hoạt động" cho phép hiển thị liên kết</p>
                </div>
                <div className="tip-item">
                  <i className="fas fa-check-circle tip-icon"></i>
