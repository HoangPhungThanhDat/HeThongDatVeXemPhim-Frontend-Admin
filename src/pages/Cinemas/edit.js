        ...
        <div className="main-container">
          <div className="pd-ltr-20">
            <div className="text-center p-5 text-muted">
              ...
              <p>Không có dữ liệu rạp chiếu.</p>
            </div>
          </div>
        </div>
      </MainLayout>
            ...
            <div className="form-section">
              <div className="section-header">
                ...
                <div className="header-text">
                  <h2 className="section-title">Chỉnh Sửa Rạp Chiếu</h2>
                  <p className="section-subtitle">Cập nhật thông tin rạp chiếu phim</p>
                </div>
              </div>
                ...
                <div className="form-group">
                  ...
                  <div className="status-selector">
                    <div
                      ...
                      onClick={() => setCinema({...cinema, Status: 'Active'})}
                    >
                    ...
                    <div
                      ...
                      onClick={() => setCinema({...cinema, Status: 'Inactive'})}
                    >
                      <div className="status-radio">
            ...
            <div className="info-section">
              <div className="info-card highlight-card">
                ...
                <p className="info-text">
                  ...
                  Việc thay đổi trạng thái sẽ ảnh hưởng đến khả năng đặt vé tại rạp này.
                </p>
              </div>
              ...
              <div className="info-card">
                ...
                <div className="info-list">
                  ...
                  <div className="info-item">
                    ...
                    <span className="info-value">{cinema.Name || "Chưa có"}</span>
                  </div>
                  <div className="info-item">
                  ...
                  <div className="info-item">
                    ...
                    <span className={`status-pill ${cinema.Status === 'Active' ? 'pill-active' : 'pill-inactive'}`}>
                      {cinema.Status === 'Active' ? 'Hoạt động' : 'Không hoạt động'}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="info-card tips-card">
                ...
                <div className="tip-item">
                  <i className="fas fa-check-circle tip-icon"></i>
                  <p>Email nên sử dụng email chính thức của rạp</p>
                </div>
              </div>
            </div>
          </div>
