          ...
          <div className="pd-ltr-20">
            ...
            >
              ...
              >
                ...
                />
                <p style={{ fontSize: "18px" }}>Không có dữ liệu vai trò.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Xem thông tin chi tiết và quản lý vai trò hệ thống
                  </p>
                </div>

                <div style={{ display: "flex", gap: "12px" }}>
                  <button
                    onClick={() => navigate(`/role/edit/${RoleId}`)}
                    style={{
                      padding: "12px 24px",
                      background: "linear-gradient(135deg, #f7931e, #e67e22)",
                      border: "none",
              ...
              >
                ...
                >
                  ...
                  >
                    <Shield size={56} color="white" strokeWidth={2} />
                  </div>
