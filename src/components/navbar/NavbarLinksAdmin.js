...
export default function HeaderLinks(props) {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Kể cả API lỗi vẫn tiếp tục xóa local data
    } finally {
  ...
  return (
    ...
    >
      ...
      <Menu>
        ...
        <MenuList
          boxShadow={shadow} p="20px" borderRadius="20px" bg={menuBg}
          border="none" mt="22px"
        ...
        >
          <Flex w="100%" mb="20px">
            <Text fontSize="md" fontWeight="600" color={textColor}>Thông báo</Text>
      ...
      <Menu>
        ...
        <MenuList
          boxShadow={shadow} p="20px"
          me={{ base: '30px', md: 'unset' }}
          borderRadius="20px" bg={menuBg} border="none" mt="22px"
          minW={{ base: 'unset' }} maxW={{ base: '360px', md: 'unset' }}
        >
          <Image src={navImage} borderRadius="16px" mb="28px" />
          <Flex flexDirection="column">
            <Link w="100%" href="https://horizon-ui.com/pro">
              <Button w="100%" h="44px" mb="10px" variant="brand">Buy Horizon UI PRO</Button>
            </Link>
      ...
      {/* ── Dark mode toggle ── */}
      <Button
        variant="no-hover" bg="transparent" p="0px"
        minW="unset" minH="unset" h="18px" w="max-content"
      ...
      <Menu>
        ...
        <MenuList
          boxShadow={shadow} p="0px" mt="10px"
        ...
        >
          ...
          <Flex flexDirection="column" p="10px">
            ...
            <MenuItem
              ...
              borderRadius="8px"
              px="14px"
              onClick={() => navigate('/admin/he-thong/profile')}
            >
            ...
            >
              <Text fontSize="sm" fontWeight="600">Đăng xuất</Text>
            </MenuItem>
          </Flex>
        </MenuList>
      </Menu>
